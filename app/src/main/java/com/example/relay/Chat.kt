...
class Chat : AppCompatActivity() {
    ...
    private fun getDeliveryDate(map: Map<String, Any>, type: Int, time: HashMap<String, Any>) {
        ...
        if(map["totalItems"] == null){
            totalItems = "-1"
            deliveryDate = "-1"
        }
        totalItems = map["totalItems"].toString()
        ...
        private fun addOrderCancelledBox(
            orderID: String,
            type: Int,
            deliveryDate: String,
            totalItems: String
...
//            params.gravity = Gravity.END
        ...
        private fun addMessageBox(messageMap: Map<String, Any>, type: Int) {
            ...
            if (type == 1) {
                ...
                viewBindingMessage =
                    LayoutMessageItemBinding.inflate(LayoutInflater.from(this@Chat))
...
//        orderButton.layoutParams = params
        ...
        private fun addOrderConfirmedBox(
            orderID: String,
            type: Int,
            deliveryDate: String,
            totalItems: String
